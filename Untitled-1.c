...
void nhapDanhSachBenhNhan(struct QuanLyVienPhi* qlvp){
	...
	void timKiemTheoTen1(const char* name, const struct QuanLyVienPhi* qlvp){
		for (int i = 0; i < qlvp->soLuongDichVu; i++){
...
int main(){
	...
	do{
		...
		printf("- 5. Lua chon dich vu                      -\n");
		printf("- 6. Hien thi danh sach dich vu da chon    -\n");
		printf("- 7. Tim dich vu theo ten                  -\n");
        printf("- 8. Sua dich vu                           -\n");
		printf("- 9. Tinh tong vien phi                    -\n") ;
        printf("- 10. Sap xep benh nhan theo vien phi tang -\n") ;
		printf("- 11. Tim benh nhan co vien phi cao nhat   -\n") ;
		...
		switch(choice){
            ...
            case 7:{
                char name[50];
                printf("\nNhap ten dich vu can tim: ");
                fgets(name, 50, stdin);
                timKiemTheoTen1(name, &qlvp);
                break;
            }
			case 8:{
				char name[50];
                printf("\nNhap thong tin dich vu can sua: ");
                fgets(name, 50, stdin);
                suaDichVu(name, &qlvp);
				break;
			}
